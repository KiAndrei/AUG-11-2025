...
// Fetch client profile image and email
$res = $conn->query("SELECT profile_image, email FROM user_form WHERE id=$client_id");
$profile_image = '';
$client_email = '';
                    ...
                    <form id="editProfileForm" class="profile-form">
                        ...
                        <div class="form-section">
                            <div class="form-group">
                                ...
                                <input type="text" id="profileName" name="name" value="<?= htmlspecialchars($_SESSION['client_name']) ?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="profileEmail">Email</label>
                                <input type="email" id="profileEmail" name="email" value="<?= htmlspecialchars($client_email) ?>" required>
                            </div>
                        </div>
